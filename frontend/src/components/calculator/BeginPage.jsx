...
function BeginPage(props) {
  return (
    ...
    <div  className="text-4xl sm:text-5xl pt-16 md:text-6xl text-center pb-6">
        <motion.h1 initial={{y:350}} animate={{y:0}} transition={{delay:1.0,duration:1.0}}>Votre projet consiste en un :</motion.h1>
    </div>
                ...
                >
                 ...
                 <motion.div
                    ...
                    <div className="">
                        <div className="text-center">
                            <div className="">
                                <img  src={both} className="object-contain mx-auto h-40 w-88"/>
                            </div>
                                    <div className="">
                                        <h5  className="text-center p-6">Site Web + application mobile</h5>
                                    </div>
                        </div>
                    </div>
