...
import { AddQuotes, DeleteQuotes } from '../../../redux/actions/projectActions'
...
const Quotes = ({project}) => {
    ...
    const updateHandler = () => {
     ...
     dispatch(AddQuotes({  files, id }))
    }
    const deleteUploadedHandler = (public_id) => {
        if (window.confirm('Are You Sure?')) {
            dispatch(DeleteQuotes({ id, public_id }))
        }
    }
    const saveFile = (url) => {
    ...
    return (
        <div className="flex flex-col glass  px-4  ">
                ...
                {isDragActive ? (
                    ...
                    <div className="text-center ">
                        <img
                            ...
                            alt=""
                        />
                        <p className="text-sm">Click or Drag & Drop your files here</p>
            ...
            <div className=" flex flex-wrap w-full gap-4">
                {info?.QuotesFiles?.length > 0 && (
                    <>
                        {info.QuotesFiles?.map((v, index) => (
                            <div className="flex items-center justify-center relative w-[40%] h-[130px] bg-slate-700 rounded-md mt-3">
                                ...
                                >
                                    <img
                                        ...
                                        alt="pdf"
                                    />
                                    <p className="text-xs text-center  break-all	">{v.fileName}</p>
                                </a>
