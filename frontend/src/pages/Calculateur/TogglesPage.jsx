...
function TogglesPage(props) {
    ...
    return (
        <div className={props.allState.index === 2 ? 'text-white ' : 'hidden'}>
            <div
                className={
                    props.allState.subtype === 'Site e-commerce'
                        ? 'absolute top-[53rem] md:top-[44rem] md:left-[4rem]'
                        : 'absolute top-[45rem] md:top-[44rem] md:left-[4rem]'
                }
            >
            ...
            <div
                className={
                    props.allState.subtype === 'Site e-commerce'
                        ? 'absolute top-[53rem] left-52 md:top-[44rem] md:right-[4rem]'
                        : 'absolute top-[45rem] left-52 md:top-[44rem] md:right-[4rem]'
                }
                // animate={{x:250,y:70}}
            >
                <button
